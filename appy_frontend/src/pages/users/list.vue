                            ...
                            <div class="page-records"  >
                                <DataTable :lazy="true"   :loading="loading"    v-model:selection="selectedItems"
                                    ...
                                    <Column selectionMode="multiple" headerStyle="width: 2rem" />
                                        ...
                                        <Column  field="user_role_id" header="User Role Id" >
                                            <template #body="{ data, index }">
                                                <Button class="p-button-text" icon="pi pi-eye" label="Roles" v-if="data.user_role_id" @click="app.openPageDialog({ page: 'roles/view', url: `/roles/view/${data.user_role_id}` , closeBtn: true })" />
                                            </template>
                                        </Column>
